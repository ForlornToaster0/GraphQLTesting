using GraphQLTesting.CustomErrors;
...
namespace GraphQLTesting.GraphQl
{
    public class Mutation
    {
        ...
        public async Task<AuthorPayload> AddAuthor(AuthorInput input, [Service] Repository.Repository repository)
        {
        ...
        public async Task<BookPayload> AddBook(BookInput input, [Service] Repository.Repository repository)
        {
